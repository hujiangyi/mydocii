...
* hadoop 知识积累
 ...
 - [部署zookeeper-3.4.10集群](hadoop/部署zookeeper-3.4.10集群.md)
 - [部署hbase-1.2.6](hadoop/部署hbase-1.2.6.md)
 - [HBase_学习](hadoop/HBase_学习.md)
...
* 第八章 linux使用技巧
 ...
 - [创建和启用Swap交换区](创建和启用Swap交换区.md)
 - [将公司机器映射到vps在家中可以访问](linux/技巧/将公司机器映射到vps在家中可以访问.md)
 - [awk统计](linux/技巧/awk统计.md)
 - [macOS_截屏快捷键](linux/技巧/macOS_截屏快捷键.md)
 - [SSH免密登陆](linux/技巧/SSH免密登陆.md)
 - [forrever制作系统服务](linux/shell/forrever制作系统服务.md)
 - [Vim_添加NERDtree插件](linux/vi/Vim_添加NERDtree插件.md)
 - [Easymotion__for_vim](linux/vi/Easymotion__for_vim.md)
 - [用ack替换grep](linux/vi/用ack替换grep.md)
 - [CentOS7使用firewalld打开关闭防火墙与端口](linux2/CentOS7使用firewalld打开关闭防火墙与端口.md)
...
* 第十六章 资料
 ...
 - [概念学习记录](pnm/概念学习记录.md)
 - [配置CM_DHCP](pnm/配置CM_DHCP.md)
